...
Notes:- 
This program uses static array for storing array for categories. Items are dynamically allocated linked lists . Memoery is freed upon program exit for dynamically created nodes. The inventory is saved in a simple text format in 'inventory.txt'. Input is straightforward string and numeric input via sacnf.
